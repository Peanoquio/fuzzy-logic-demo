...
{
	class CylinderBuilder : public BaseGeometryBuilder
	{
	public:
		CylinderBuilder( void );
		virtual ~CylinderBuilder( void );
		...
		//option #2
		void ComputeGeometryBoundaryAndOffset( const GLfloat height = 1.0F, const GLuint stacks = 1 );
	...
	private:		
		...
		void ComputeGeometryBoundaryAndOffsetSubFunc( const GLfloat height = 1.0F, const GLuint stacks = 1 );
